...
/**
 * Copy from https://github.com/JakeWharton/kotterknife/blob/master/src/main/kotlin/kotterknife/ButterKnife.kt
 */
...
fun <V : View> LinearLayoutListHelper.ViewHolder.bindView(id: Int)
        : ReadOnlyProperty<LinearLayoutListHelper.ViewHolder, V> = required(id, viewFinder)
...
private val LinearLayoutListHelper.ViewHolder.viewFinder: Finder<LinearLayoutListHelper.ViewHolder>
    get() = { itemView.findViewById(it) }
